...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: localeAlternates(locale, "/kit"),
    openGraph: {
      title: b.metaTitle,
      description: b.metaDesc,
      type: "article",
...
export default async function KitBriefPage({
  ...
  const url = `${SITE}/${locale}/kit`;
  const mdHref =
    locale === "en"
      ? "/docs/karukera-security-kit.en.md"
      : locale === "es"
        ? "/docs/karukera-security-kit.es.md"
        : "/docs/karukera-security-kit.md";
