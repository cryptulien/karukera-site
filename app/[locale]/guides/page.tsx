    ...
    <div className="min-h-screen bg-isle-salt text-isle-ink">
      ...
      <main>
        <section className="max-w-5xl mx-auto px-5 sm:px-8 pt-16 sm:pt-24 pb-12">
          <p className="text-xs tracking-[0.18em] uppercase text-isle-flame font-medium">
            {dict.guides.modesEyebrow}
          </p>
          <h1 className="mt-4 font-serif text-[2.1rem] sm:text-5xl font-normal tracking-[-0.03em] leading-[1.08] max-w-3xl">
            {dict.guides.indexTitle}
          </h1>
          <p className="mt-6 text-lg text-isle-stone max-w-2xl leading-relaxed">
          ...
          <article className="rounded-2xl bg-white p-8 sm:p-10 shadow-[0_12px_40px_-18px_rgba(22,22,22,0.22)]">
            ...
            <h2 className="mt-3 text-2xl sm:text-3xl font-semibold tracking-tight leading-snug">
              <Link
                ...
                className="hover:text-isle-flame"
              >
                {pillarC.title}
              </Link>
            </h2>
            <p className="mt-4 text-isle-stone leading-relaxed">{pillarC.excerpt}</p>
            <Link
              href={`/${locale}/guides/${pillar.slug}`}
          ...
          {modes.map((g) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-3 text-sm text-isle-stone leading-relaxed flex-1">
                  {c.excerpt}
                </p>
                <Link
                  href={`/${locale}/guides/${g.slug}`}
                  className="mt-5 text-sm font-medium text-isle-flame self-start"
                >
                  {dict.guides.read} →
                </Link>
              </article>
